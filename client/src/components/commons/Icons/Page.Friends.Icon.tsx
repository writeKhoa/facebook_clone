import { MultiIcon10, MultiIcon13 } from "@/assets/images";

export const HomeFriendIcon = () => {
  return (
...
export const FriendSuggestIcon = () => {
  return (
    <i
      data-visualcompletion="css-img"
      className="filter-black dark:filter-white"
...
export const FriendListIcon = () => {
  return (
    <i
      ...
      className="filter-black dark:filter-white"
      style={{
        backgroundImage: `url(${MultiIcon13})`,
        backgroundPosition: "0px -376px",
        backgroundSize: "26px 798px",
        width: "20px",
        height: "20px",
        backgroundRepeat: "no-repeat",
        display: "inline-block",
